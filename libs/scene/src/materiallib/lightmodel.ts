...
export abstract class LightModel {
    ...
    if (!pb.getFunction(funcNameGetSurfaceData)) {
      ...
      pb.globalScope.$function(funcNameGetSurfaceData, params, function () {
        ...
        this.surfaceData.viewVec = pb.normalize(
          pb.sub(pb.queryGlobal(ShaderLib.USAGE_CAMERA_POSITION), this.worldPos)
        );
  ...
  calculateNormal(
    ...
    return this.calculatePixelNormal(
      scope,
      this.calculateTBN(scope, worldPosition, worldNormal, worldTangent, worldBinormal)
    );
  }
    ...
    if (!pb.getFunction(funcNameCalculatePixelNormal)) {
      pb.globalScope.$function(funcNameCalculatePixelNormal, [pb.mat3('TBN')], function () {
        if (that.normalMap) {
          ...
          this.$l.normalTex = pb.sub(
            pb.mul(
              pb.textureSample(
                this[that.getTextureUniformName(TEX_NAME_NORMAL)],
                this.$inputs[`texcoord${that.normalMapTexCoord}`]
              ).rgb,
              2
            ),
            pb.vec3(1)
        ...
        this.$return(
          pb.defineStruct('', 'default', pb.mat3('TBN'), pb.vec3('normal'))(this.TBN, this.pixelNormal)
        );
      });
    }
  ...
  envBRDF(envLight: EnvironmentLighting, scope: PBInsideFunctionScope, surfaceData: PBShaderExp): void {
    ...
    if (envLight.isConstant()) {
      if (!pb.getFunction(LambertLightModel.funcNameBRDFEnvConstantAmbient)) {
        pb.globalScope.$function(
          LambertLightModel.funcNameBRDFEnvConstantAmbient,
          [pb.struct(surfaceData.getTypeName(), 'surfaceData')],
          function () {
            this.surfaceData.accumDiffuse = pb.add(
              this.surfaceData.accumDiffuse,
              pb.mul(
                pb.queryGlobal(EnvConstantAmbient.USAGE_CONSTANT_AMBIENT_LIGHTING).rgb,
      ...
      if (!pb.getFunction(LambertLightModel.funcNameBRDFEnvIBL)) {
        pb.globalScope.$function(
          LambertLightModel.funcNameBRDFEnvIBL,
          [pb.struct(surfaceData.getTypeName(), 'surfaceData')],
          function () {
            this.$l.irradiance = pb.mul(
              pb.textureSample(pb.queryGlobal(EnvIBL.USAGE_IBL_IRRADIANCE_MAP), this.surfaceData.normal).rgb,
              this.surfaceData.diffuse.rgb
            );
            this.surfaceData.accumDiffuse = pb.add(
              this.surfaceData.accumDiffuse,
              pb.mul(this.irradiance, pb.queryGlobal(ShaderLib.USAGE_ENV_LIGHT_STRENGTH))
            );
          }
        );
      }
  ...
  directBRDF(
    ...
    if (!pb.getFunction(LambertLightModel.funcNameBRDFDirect)) {
      pb.globalScope.$function(
        ...
        [pb.struct(surfaceData.getTypeName(), 'surfaceData'), pb.vec3('attenuation')],
        function () {
          this.surfaceData.accumDiffuse = pb.add(
            this.surfaceData.accumDiffuse,
...
export abstract class PBRLightModelBase extends LightModel {
  ...
  /** @internal */
  protected fresnelSchlickRoughness(
    scope: PBInsideFunctionScope,
    NdotV: PBShaderExp,
    F0: PBShaderExp,
    ...
    if (!pb.getFunction(PBRLightModelBase.funcNameFresnelSchlickRoughness)) {
      pb.globalScope.$function(
        PBRLightModelBase.funcNameFresnelSchlickRoughness,
        [pb.float('NdotV'), pb.vec3('f0'), pb.float('roughness')],
        function () {
          this.$return(
            pb.add(
              this.f0,
  ...
  /** @internal */
  protected envDFGLazarov(
    scope: PBInsideFunctionScope,
    specularColor: PBShaderExp,
    gloss: PBShaderExp,
    NdotV: PBShaderExp
  ): PBShaderExp {
    const pb = scope.$builder;
    if (!pb.getFunction(PBRLightModelBase.funcNameEnvDFGLazarov)) {
      pb.globalScope.$function(
        PBRLightModelBase.funcNameEnvDFGLazarov,
        [pb.vec3('specularColor'), pb.float('gloss'), pb.float('NdotV')],
        function () {
          ...
          this.$l.bias = pb.clamp(
            pb.add(pb.mul(this.t.x, pb.min(this.t.y, pb.exp2(pb.mul(-7.672, this.NdotV)))), this.t.z),
            0,
            1
          );
    ...
    if (!pb.getFunction(PBRLightModelBase.funcNameIllumEnvLight)) {
      pb.globalScope.$function(
        ...
        function () {
          ...
          this.$l.F = that.fresnelSchlickRoughness(
            this,
          ...
          if (that._clearcoat) {
            this.$l.ccF = that.fresnelSchlickRoughness(
              this,
              this.surfaceData.clearcoatNdotV,
              this.f0,
              this.surfaceData.clearcoatFactor.y
            );
            this.$l.ccfab = that.envDFGUE4(
              this,
              this.surfaceData.clearcoatFactor.y,
              this.surfaceData.clearcoatNdotV
            );
            this.$l.ccfr = pb.sub(
              pb.max(pb.vec3(pb.sub(1, this.surfaceData.clearcoatFactor.y)), this.f0),
              this.f0
            );
            this.$l.cckS = pb.add(
              this.f0,
              pb.mul(this.ccfr, pb.pow(pb.sub(1, this.surfaceData.clearcoatNdotV), 5))
            );
            this.$l.cct = pb.mul(this.cckS, this.ccfab.x);
            this.$l.ccspec = pb.mul(
              this.surfaceData.radianceClearcoat,
              pb.add(this.cct, pb.vec3(this.ccfab.y))
            );
            this.surfaceData.clearcoatContrib = pb.add(
              this.surfaceData.clearcoatContrib,
              pb.mul(this.ccspec, this.surfaceData.occlusion.r)
            );
          }
          ...
          this.surfaceData.accumDiffuse = pb.add(
            this.surfaceData.accumDiffuse,
            pb.mul(this.diff, this.surfaceData.occlusion.r)
          );
          this.surfaceData.accumSpecular = pb.add(
            this.surfaceData.accumSpecular,
            pb.mul(this.spec, this.surfaceData.occlusion.r)
          );
          if (that._sheen) {
            this.surfaceData.sheenContrib = pb.add(
              this.surfaceData.sheenContrib,
              pb.mul(this.surfaceData.radianceSheen, this.surfaceData.occlusion.r)
            );
          }
        }
      );
  ...
  envBRDF(envLight: EnvironmentLighting, scope: PBInsideFunctionScope, surfaceData: PBShaderExp): void {
    if (envLight.isConstant()) {
      ...
      if (!pb.getFunction(PBRLightModelBase.funcNameBRDFEnvConstantAmbient)) {
        pb.globalScope.$function(
          PBRLightModelBase.funcNameBRDFEnvConstantAmbient,
          [pb.struct(surfaceData.getTypeName(), 'surfaceData')],
          function () {
            this.surfaceData.accumDiffuse = pb.add(
              this.surfaceData.accumDiffuse,
  ...
  protected fresnelSchlick(
    ...
    if (!pb.getFunction(PBRLightModelBase.funcNameFresnelSchlick)) {
      pb.globalScope.$function(
        PBRLightModelBase.funcNameFresnelSchlick,
  ...
  directBRDF(
    ...
    if (!pb.getFunction(PBRLightModelBase.funcNameCalcPBRLight)) {
      pb.globalScope.$function(
        ...
        [pb.struct(surfaceData.getTypeName(), 'surfaceData'), pb.vec3('lightDir'), pb.vec3('attenuation')],
        function () {
          ...
          this.surfaceData.accumSpecular = pb.add(
            this.surfaceData.accumSpecular,
            pb.mul(this.D, this.V, this.F, this.surfaceData.specularWeight, this.attenuation)
          );
          this.surfaceData.accumDiffuse = pb.add(
            this.surfaceData.accumDiffuse,
            pb.mul(
              pb.sub(pb.vec3(1), pb.mul(this.F, this.surfaceData.specularWeight)),
              pb.div(this.surfaceData.diffuse.rgb, Math.PI),
              this.attenuation
            )
          );
          if (that._sheen) {
            this.surfaceData.sheenContrib = pb.add(
              this.surfaceData.sheenContrib,
              pb.mul(that.sheenDirect(this, this.surfaceData, this.NdotL, this.NdotH), this.attenuation)
            );
          }
          if (that._clearcoat) {
            this.$l.ccRoughness = pb.mul(
              this.surfaceData.clearcoatFactor.y,
              this.surfaceData.clearcoatFactor.y
            );
            ...
            this.surfaceData.clearcoatContrib = pb.add(
              this.surfaceData.clearcoatContrib,
              pb.mul(this.ccD, this.ccV, this.F, this.attenuation)
            );
          }
        }
      );
  ...
  protected compositeSurfaceData(scope: PBInsideFunctionScope, surfaceData: PBShaderExp) {
    ...
    const pb = scope.$builder;
    if (this._sheen) {
      surfaceData.accumColor = pb.add(
        pb.mul(surfaceData.accumColor, surfaceData.sheenAlbedoScaling),
        surfaceData.sheenContrib
      );
    }
    if (this._clearcoat) {
      surfaceData.accumColor = pb.add(
        pb.mul(
          surfaceData.accumColor,
          pb.sub(pb.vec3(1), pb.mul(surfaceData.clearcoatFresnel, surfaceData.clearcoatFactor.x))
        ),
        pb.mul(surfaceData.clearcoatContrib, surfaceData.clearcoatFactor.x)
      );
      ...
      pb.globalScope.$function(
        ...
        function () {
          this.surfaceData.f0 = pb.vec4(
            pb.queryGlobal(PBRLightModelSG.uniformSpecularFactor).rgb,
          ...
          if (that._clearcoat) {
            this.surfaceData.clearcoatFresnel = that.fresnelSchlick(
              this,
              this.surfaceData.clearcoatNdotV,
          ...
          if (envLight?.isIBL()) {
            this.surfaceData.irradiance = pb.textureSample(
              pb.queryGlobal(EnvIBL.USAGE_IBL_IRRADIANCE_MAP),
              this.surfaceData.normal
            ).rgb;
            ...
            this.surfaceData.radiance = pb.device?.getShaderCaps().supportShaderTextureLod
              ? pb.textureSampleLevel(
                  pb.queryGlobal(EnvIBL.USAGE_IBL_RADIANCE_MAP),
                  this.refl,
                  pb.mul(this.surfaceData.roughness, this.maxLod)
                ).rgb
            ...
            if (that.useSheen) {
              const r = pb.device?.getShaderCaps().supportShaderTextureLod
                ? pb.textureSampleLevel(
                    pb.queryGlobal(EnvIBL.USAGE_IBL_RADIANCE_MAP),
                    this.refl,
                    pb.mul(this.surfaceData.sheenRoughness, this.maxLod)
                  ).rgb
                : this.surfaceData.radiance;
            ...
            if (that.useClearcoat) {
              ...
              this.surfaceData.radianceClearcoat = pb.device?.getShaderCaps().supportShaderTextureLod
                ? pb.textureSampleLevel(
                    pb.queryGlobal(EnvIBL.USAGE_IBL_RADIANCE_MAP),
                    this.ccRefl,
                    pb.mul(this.surfaceData.clearcoatFactor.y, this.maxLod)
                  ).rgb
                : this.surfaceData.radiance;
            }
          }
