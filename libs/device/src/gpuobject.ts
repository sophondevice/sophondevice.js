...
import type { TextureTarget, CompareFunc, TextureWrapping, TextureFilter, DataType, PrimitiveType, TextureFormat } from './base_types';
...
const vertexAttribFormatMap = {
  ...
  custom0_u8normx2: [VERTEX_ATTRIB_CUSTOM0, PBPrimitiveType.U8VEC2_NORM, 2, 'u8norm', 2],
  custom0_u8normx4: [VERTEX_ATTRIB_CUSTOM0, PBPrimitiveType.U8VEC4_NORM, 4, 'u8norm', 4],
  custom0_i8normx2: [VERTEX_ATTRIB_CUSTOM0, PBPrimitiveType.I8VEC2_NORM, 2, 'i8norm', 2],
  custom0_i8normx4: [VERTEX_ATTRIB_CUSTOM0, PBPrimitiveType.I8VEC4_NORM, 4, 'i8norm', 4],
  custom0_u16x2: [VERTEX_ATTRIB_CUSTOM0, PBPrimitiveType.U16VEC2, 4, 'u16', 2],
  custom0_u16x4: [VERTEX_ATTRIB_CUSTOM0, PBPrimitiveType.U16VEC4, 8, 'u16', 4],
  custom0_i16x2: [VERTEX_ATTRIB_CUSTOM0, PBPrimitiveType.I16VEC2, 4, 'i16', 2],
  custom0_i16x4: [VERTEX_ATTRIB_CUSTOM0, PBPrimitiveType.I16VEC4, 8, 'i16', 4],
  custom0_u16normx2: [VERTEX_ATTRIB_CUSTOM0, PBPrimitiveType.U16VEC2_NORM, 4, 'u16norm', 2],
  custom0_u16normx4: [VERTEX_ATTRIB_CUSTOM0, PBPrimitiveType.U16VEC4_NORM, 8, 'u16norm', 4],
  custom0_i16normx2: [VERTEX_ATTRIB_CUSTOM0, PBPrimitiveType.I16VEC2_NORM, 4, 'i16norm', 2],
  custom0_i16normx4: [VERTEX_ATTRIB_CUSTOM0, PBPrimitiveType.I16VEC4_NORM, 8, 'i16norm', 4],
  custom0_f16x2: [VERTEX_ATTRIB_CUSTOM0, PBPrimitiveType.F16VEC2, 4, 'f16', 2],
  custom0_f16x4: [VERTEX_ATTRIB_CUSTOM0, PBPrimitiveType.F16VEC4, 8, 'f16', 4],
  custom0_f32: [VERTEX_ATTRIB_CUSTOM0, PBPrimitiveType.F32, 4, 'f32', 1],
  custom0_f32x2: [VERTEX_ATTRIB_CUSTOM0, PBPrimitiveType.F32VEC2, 8, 'f32', 2],
  custom0_f32x3: [VERTEX_ATTRIB_CUSTOM0, PBPrimitiveType.F32VEC3, 12, 'f32', 3],
  custom0_f32x4: [VERTEX_ATTRIB_CUSTOM0, PBPrimitiveType.F32VEC4, 16, 'f32', 4],
  custom0_i32: [VERTEX_ATTRIB_CUSTOM0, PBPrimitiveType.I32, 4, 'i32', 1],
  custom0_i32x2: [VERTEX_ATTRIB_CUSTOM0, PBPrimitiveType.I32VEC2, 8, 'i32', 2],
  custom0_i32x3: [VERTEX_ATTRIB_CUSTOM0, PBPrimitiveType.I32VEC3, 12, 'i32', 3],
  custom0_i32x4: [VERTEX_ATTRIB_CUSTOM0, PBPrimitiveType.I32VEC4, 16, 'i32', 4],
  custom0_u32: [VERTEX_ATTRIB_CUSTOM0, PBPrimitiveType.U32, 4, 'u32', 1],
  custom0_u32x2: [VERTEX_ATTRIB_CUSTOM0, PBPrimitiveType.U32VEC2, 8, 'u32', 2],
  custom0_u32x3: [VERTEX_ATTRIB_CUSTOM0, PBPrimitiveType.U32VEC3, 12, 'u32', 3],
  custom0_u32x4: [VERTEX_ATTRIB_CUSTOM0, PBPrimitiveType.U32VEC4, 16, 'u32', 4],
  custom1_u8normx2: [VERTEX_ATTRIB_CUSTOM1, PBPrimitiveType.U8VEC2_NORM, 2, 'u8norm', 2],
  custom1_u8normx4: [VERTEX_ATTRIB_CUSTOM1, PBPrimitiveType.U8VEC4_NORM, 4, 'u8norm', 4],
  custom1_i8normx2: [VERTEX_ATTRIB_CUSTOM1, PBPrimitiveType.I8VEC2_NORM, 2, 'i8norm', 2],
  custom1_i8normx4: [VERTEX_ATTRIB_CUSTOM1, PBPrimitiveType.I8VEC4_NORM, 4, 'i8norm', 4],
  custom1_u16x2: [VERTEX_ATTRIB_CUSTOM1, PBPrimitiveType.U16VEC2, 4, 'u16', 2],
  custom1_u16x4: [VERTEX_ATTRIB_CUSTOM1, PBPrimitiveType.U16VEC4, 8, 'u16', 4],
  custom1_i16x2: [VERTEX_ATTRIB_CUSTOM1, PBPrimitiveType.I16VEC2, 4, 'i16', 2],
  custom1_i16x4: [VERTEX_ATTRIB_CUSTOM1, PBPrimitiveType.I16VEC4, 8, 'i16', 4],
  custom1_u16normx2: [VERTEX_ATTRIB_CUSTOM1, PBPrimitiveType.U16VEC2_NORM, 4, 'u16norm', 2],
  custom1_u16normx4: [VERTEX_ATTRIB_CUSTOM1, PBPrimitiveType.U16VEC4_NORM, 8, 'u16norm', 4],
  custom1_i16normx2: [VERTEX_ATTRIB_CUSTOM1, PBPrimitiveType.I16VEC2_NORM, 4, 'i16norm', 2],
  custom1_i16normx4: [VERTEX_ATTRIB_CUSTOM1, PBPrimitiveType.I16VEC4_NORM, 8, 'i16norm', 4],
  custom1_f16x2: [VERTEX_ATTRIB_CUSTOM1, PBPrimitiveType.F16VEC2, 4, 'f16', 2],
  custom1_f16x4: [VERTEX_ATTRIB_CUSTOM1, PBPrimitiveType.F16VEC4, 8, 'f16', 4],
  custom1_f32: [VERTEX_ATTRIB_CUSTOM1, PBPrimitiveType.F32, 4, 'f32', 1],
  custom1_f32x2: [VERTEX_ATTRIB_CUSTOM1, PBPrimitiveType.F32VEC2, 8, 'f32', 2],
  custom1_f32x3: [VERTEX_ATTRIB_CUSTOM1, PBPrimitiveType.F32VEC3, 12, 'f32', 3],
  custom1_f32x4: [VERTEX_ATTRIB_CUSTOM1, PBPrimitiveType.F32VEC4, 16, 'f32', 4],
  custom1_i32: [VERTEX_ATTRIB_CUSTOM1, PBPrimitiveType.I32, 4, 'i32', 1],
  custom1_i32x2: [VERTEX_ATTRIB_CUSTOM1, PBPrimitiveType.I32VEC2, 8, 'i32', 2],
  custom1_i32x3: [VERTEX_ATTRIB_CUSTOM1, PBPrimitiveType.I32VEC3, 12, 'i32', 3],
  custom1_i32x4: [VERTEX_ATTRIB_CUSTOM1, PBPrimitiveType.I32VEC4, 16, 'i32', 4],
  custom1_u32: [VERTEX_ATTRIB_CUSTOM1, PBPrimitiveType.U32, 4, 'u32', 1],
  custom1_u32x2: [VERTEX_ATTRIB_CUSTOM1, PBPrimitiveType.U32VEC2, 8, 'u32', 2],
  custom1_u32x3: [VERTEX_ATTRIB_CUSTOM1, PBPrimitiveType.U32VEC3, 12, 'u32', 3],
  custom1_u32x4: [VERTEX_ATTRIB_CUSTOM1, PBPrimitiveType.U32VEC4, 16, 'u32', 4]
} as const;
...
export function getVertexFormatComponentType(fmt: VertexAttribFormat): DataType {
