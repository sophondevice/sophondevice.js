import { TextureTarget, getTextureFormatBlockWidth, getTextureFormatBlockHeight, getTextureFormatBlockSize, linearTextureFormatToSRGB } from '../base_types';
import { WebGPUBaseTexture } from './basetexture_webgpu';
import { GPUResourceUsageFlags } from '../gpuobject';
export class WebGPUTexture2DArray extends WebGPUBaseTexture {
    constructor(device) {
