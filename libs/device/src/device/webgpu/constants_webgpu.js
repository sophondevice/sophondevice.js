...
export const vertexFormatToHash = {
    float32: '0',
    float32x2: '1',
    float32x3: '2',
    float32x4: '3',
...
export const textureFormatInvMap = zip(Object.values(textureFormatMap), Object.keys(textureFormatMap).map(val => Number(val)));
export const hashToVertexFormat = zip(Object.values(vertexFormatToHash), Object.keys(vertexFormatToHash));
