...
export var ShaderPrecisionType;
...
export function getBuiltinInputStructInstanceName(shaderType) {
    switch (shaderType) {
...
export function getBuiltinOutputStructInstanceName(shaderType) {
    switch (shaderType) {
...
export function getBuiltinInputStructName(shaderType) {
    switch (shaderType) {
...
export function getBuiltinOutputStructName(shaderType) {
    switch (shaderType) {
...
export function getTextureSampleType(type) {
...
export function genSamplerName(textureName, comparison) {
...
export class ASTExpression extends ShaderAST {
}
...
export class ASTLValue extends ShaderAST {
}
...
export class ASTAssignment extends ShaderAST {
    ...
    toWebGL(indent, ctx) {
        ...
        if (typeof this.rvalue === 'number' || typeof this.rvalue === 'boolean') {
            rhs = rtype.primitiveType === typeinfo.PBPrimitiveType.F32 ? toFixed(this.rvalue) : String(this.rvalue);
        }
        else {
