...
export var GPUResourceUsageFlags;
...
export function getVertexAttribByName(name) {
    return vertexAttribNameMap[name];
}
export function getVertexAttribName(attrib) {
    return vertexAttribNameRevMap[attrib];
}
export function getVertexFormatSize(fmt) {
    return vertexAttribFormatMap[fmt][2];
}
export function getVertexBufferLength(vertexBufferType) {
    return vertexBufferType.structMembers[0].type.dimension;
}
export function getVertexBufferStride(vertexBufferType) {
...
export function getVertexBufferAttribType(vertexBufferType, attrib) {
...
export function makeVertexBufferType(length, ...attributes) {
...
export const semanticList = (function () {
    const list = [];
...
export function semanticToAttrib(semantic) {
    switch (semantic) {
...
export function genDefaultName(obj) {
    if (obj.isTexture2D()) {
        return 'texture_2d';
    }
