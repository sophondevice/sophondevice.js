...
export class WebGLColorState extends WebGLRenderState {
...
export class WebGLBlendingState extends WebGLRenderState {
...
export class WebGLRasterizerState extends WebGLRenderState {
...
export class WebGLDepthState extends WebGLRenderState {
...
export class WebGLStencilState extends WebGLRenderState {
...
export class WebGLRenderStateSet {
    _gl;
    _colorState;
    _blendingState;
    _rasterizerState;
