...
export function makeTextureFormat(compression, r, g, b, a, depth, stencil, float, integer, signed, srgb, bgr, blockWidth, blockHeight, blockSize) {
...
export function linearTextureFormatToSRGB(format) {
    switch (format) {
...
export function hasAlphaChannel(format) {
    return !!(format & ALPHA_BITMASK);
}
export function hasRedChannel(format) {
    return !!(format & RED_BITMASK);
}
export function hasGreenChannel(format) {
    return !!(format & GREEN_BITMASK);
}
export function hasBlueChannel(format) {
    return !!(format & BLUE_BITMASK);
}
export function hasDepthChannel(format) {
    return !!(format & DEPTH_BITMASK);
}
export function hasStencilChannel(format) {
    return !!(format & STENCIL_BITMASK);
}
export function isFloatTextureFormat(format) {
    return !!(format & FLOAT_BITMASK);
}
export function isIntegerTextureFormat(format) {
    return !!(format & INTEGER_BITMASK);
}
export function isSignedTextureFormat(format) {
...
export function isSRGBTextureFormat(format) {
    return !!(format & SRGB_BITMASK);
}
export function getTextureFormatBlockSize(format) {
    return (format & BLOCK_SIZE_MASK) >> BLOCK_SIZE_SHIFT;
}
export function getTextureFormatBlockWidth(format) {
    return (format & BLOCK_WIDTH_MASK) >> BLOCK_WIDTH_SHIFT;
}
export function getTextureFormatBlockHeight(format) {
    return (format & BLOCK_HEIGHT_MASK) >> BLOCK_HEIGHT_SHIFT;
}
export function getCompressedTextureFormat(format) {
...
export function halfToFloat(val) {
...
export function encodePixelToArray(format, r, g, b, a, arr) {
    switch (format) {
        case TextureFormat.R8UNORM:
