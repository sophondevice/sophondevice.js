...
export class Shape extends Primitive {
    _options;
...
export class PlaneShape extends Shape {
    ...
    _createArrays(vertices, normals, uvs, indices, sizeX, sizeY) {
...
export class BoxShape extends Shape {
    ...
    _createArrays(vertices, normals, uvs, indices, minx, miny, minz, maxx, maxy, maxz) {
...
export class BoxFrameShape extends Shape {
    constructor(device, options) {
        super(device, options);
    }
    createDefaultOptions() {
    ...
    _createArrays(vertices, indices, minx, miny, minz, maxx, maxy, maxz) {
        const topFacePos = [minx, maxy, minz, minx, maxy, maxz, maxx, maxy, maxz, maxx, maxy, minz];
        const bottomFacePos = [minx, miny, maxz, minx, miny, minz, maxx, miny, minz, maxx, miny, maxz];
