...
class ImageManager {
    ...
    _createBuiltinImages() {
        ...
        this._cachedImages['default.input'] = new TextureAtlas(this._atlasManager.getAtlasTexture(atlasInfo.atlasIndex), { x: atlasInfo.uMin, y: atlasInfo.vMin }, { x: atlasInfo.uMax, y: atlasInfo.vMax }, { x: 0.5, y: 0.5 }, { x: 0.5, y: 0.5 });
        ctx.clearRect(0, 0, size, size);
        ctx.beginPath();
        ctx.ellipse(1 + radius + offsetX, 1 + radius + offsetY, radius, radius, 0, 0, 2 * Math.PI);
        ctx.fill();
        atlasInfo = this._atlasManager.pushCanvas('default.button', ctx, 0, 0, size, size);
        this._cachedImages['default.button'] = new TextureAtlas(this._atlasManager.getAtlasTexture(atlasInfo.atlasIndex), { x: atlasInfo.uMin, y: atlasInfo.vMin }, { x: atlasInfo.uMax, y: atlasInfo.vMax }, { x: 0.5, y: 0.5 }, { x: 0.5, y: 0.5 });
        size = 32;
        ctx.fillStyle = '#ffffff';
        ...
        this._cachedImages['default.scrollbar.down'] = new TextureAtlas(this._atlasManager.getAtlasTexture(atlasInfo.atlasIndex), { x: atlasInfo.uMin, y: atlasInfo.vMin }, { x: atlasInfo.uMax, y: atlasInfo.vMax });
        ctx.fillStyle = '#ffffff';
        ctx.fillRect(0, 0, size, size);
        ctx.fillStyle = '#aaaaaa';
        ...
        this._cachedImages['default.scrollbar.up'] = new TextureAtlas(this._atlasManager.getAtlasTexture(atlasInfo.atlasIndex), { x: atlasInfo.uMin, y: atlasInfo.vMin }, { x: atlasInfo.uMax, y: atlasInfo.vMax });
        ctx.fillStyle = '#ffffff';
        ctx.fillRect(0, 0, size, size);
        ctx.fillStyle = '#aaaaaa';
        ...
        this._cachedImages['default.scrollbar.left'] = new TextureAtlas(this._atlasManager.getAtlasTexture(atlasInfo.atlasIndex), { x: atlasInfo.uMin, y: atlasInfo.vMin }, { x: atlasInfo.uMax, y: atlasInfo.vMax });
        ctx.fillStyle = '#ffffff';
        ctx.fillRect(0, 0, size, size);
        ctx.fillStyle = '#aaaaaa';
        ...
        this._cachedImages['default.scrollbar.right'] = new TextureAtlas(this._atlasManager.getAtlasTexture(atlasInfo.atlasIndex), { x: atlasInfo.uMin, y: atlasInfo.vMin }, { x: atlasInfo.uMax, y: atlasInfo.vMax });
        cvs = null;
    }
}
