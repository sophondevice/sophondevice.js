/** sophon base library */
import { YGEdgeCount, YGDirection, YGFlexDirection, YGJustify, YGAlign, YGPositionType, YGWrap, YGOverflow, YGDisplay, YGUnit } from './enums.js';
...
const kYGValueUndefined = function () {
    return new YGValue(0, YGUnit.Undefined);
};
const kYGValueAuto = function () {
    return new YGValue(0, YGUnit.Auto);
};
const kYGDefaultEdgeValuesUnit = function () {
    return [
        kYGValueUndefined(),
        kYGValueUndefined(),
        kYGValueUndefined(),
...
const kYGDefaultDimensionValuesAutoUnit = function () {
    return [
        kYGValueAuto(),
        kYGValueAuto(),
    ];
};
const kYGDefaultDimensionValuesUnit = function () {
    return [
        kYGValueUndefined(),
        kYGValueUndefined(),
    ];
