import { YGEdge, YGNodeType, YGFlexDirection, YGAlign, YGMeasureMode, YGLogLevel, YGDirection, YGJustify, YGPositionType, YGWrap, YGOverflow, YGDisplay, YGPrintOptions, YGExperimentalFeature } from './enums';
...
export declare function YGNodeGetContext(node: YGNode): any;
export declare function YGNodeSetContext(node: YGNode, context: any): void;
export declare function YGNodeGetMeasureFunc(node: YGNode): YGMeasureFunc;
export declare function YGNodeSetMeasureFunc(node: YGNode, measureFunc: YGMeasureFunc): void;
export declare function YGNodeGetBaselineFunc(node: YGNode): YGBaselineFunc;
...
export declare function YGNodeGetPrintFunc(node: YGNode): YGPrintFunc;
...
export declare function YGNodeGetInstanceCount(): number;
...
export declare function YGNodeInsertChild(node: YGNode, child: YGNode, index: number): void;
export declare function YGNodeInsertSharedChild(node: YGNode, child: YGNode, index: number): void;
...
export declare function YGNodeLayoutGetMargin(node: YGNode, edge: YGEdge): number;
export declare function YGNodeLayoutGetBorder(node: YGNode, edge: YGEdge): number;
export declare function YGNodeLayoutGetPadding(node: YGNode, edge: YGEdge): number;
...
export declare function YGBaseline(node: YGNode): number;
...
export declare function YGNodeBoundAxisWithinMinAndMax(node: YGNode, axis: YGFlexDirection, value: number, axisSize: number): YGFloatOptional;
...
export declare function YGNodeComputeFlexBasisForChild(node: YGNode, child: YGNode, width: number, widthMode: YGMeasureMode, height: number, ownerWidth: number, ownerHeight: number, heightMode: YGMeasureMode, direction: YGDirection, config: YGConfig): void;
export declare function YGNodeAbsoluteLayoutChild(node: YGNode, child: YGNode, width: number, widthMode: YGMeasureMode, height: number, direction: YGDirection, config: YGConfig): void;
export declare function YGNodeWithMeasureFuncSetMeasuredDimensions(node: YGNode, availableWidth: number, availableHeight: number, widthMeasureMode: YGMeasureMode, heightMeasureMode: YGMeasureMode, ownerWidth: number, ownerHeight: number): void;
...
export declare function YGZeroOutLayoutRecursivly(node: YGNode): void;
export declare function YGNodeCalculateAvailableInnerDim(node: YGNode, axis: YGFlexDirection, availableDim: number, ownerDim: number): number;
export declare function YGNodeComputeFlexBasisForChildren(node: YGNode, availableInnerWidth: number, availableInnerHeight: number, widthMeasureMode: YGMeasureMode, heightMeasureMode: YGMeasureMode, direction: YGDirection, mainAxis: YGFlexDirection, config: YGConfig, performLayout: boolean, totalOuterFlexBasisRef: {
    value: number;
}): void;
...
export declare function YGNodelayoutImpl(node: YGNode, availableWidth: number, availableHeight: number, ownerDirection: YGDirection, widthMeasureMode: YGMeasureMode, heightMeasureMode: YGMeasureMode, ownerWidth: number, ownerHeight: number, performLayout: boolean, config: YGConfig): void;
...
export declare function YGLayoutNodeInternal(node: YGNode, availableWidth: number, availableHeight: number, ownerDirection: YGDirection, widthMeasureMode: YGMeasureMode, heightMeasureMode: YGMeasureMode, ownerWidth: number, ownerHeight: number, performLayout: boolean, reason: string, config: YGConfig): boolean;
...
export declare function YGVLog(config: YGConfig, node: YGNode, level: YGLogLevel, format: string, ...args: any[]): void;
export declare function YGLogWithConfig(config: YGConfig, level: YGLogLevel, format: string, ...args: any[]): void;
export declare function YGLog(node: YGNode, level: YGLogLevel, format: string, ...args: any[]): void;
export declare function YGAssert(condition: boolean, message: string): void;
export declare function YGAssertWithNode(node: YGNode, condition: boolean, message: string): void;
