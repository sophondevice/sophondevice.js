/** sophon base library */
import { MAX_TEXCOORD_INDEX_COUNT } from '../../device/gpuobject.js';
...
import { MATERIAL_FUNC_DEPTH_ONLY, MATERIAL_FUNC_DEPTH_SHADOW, MATERIAL_FUNC_NORMAL } from '../values.js';
...
class StandardMaterial extends Material {
    ...
    _createProgram(pb, ctx, func) {
        ...
        const useNormal = that._hasNormal && (func !== MATERIAL_FUNC_DEPTH_ONLY && (that._lightModel?.isNormalUsed()));
