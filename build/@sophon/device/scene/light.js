/** sophon base library */
import { Vector4, Matrix4x4, Vector3 } from '@sophon/base';
...
import { LIGHT_TYPE_ENVIRONMENT, LIGHT_TYPE_HEMISPHERIC, LIGHT_TYPE_DIRECTIONAL, LIGHT_TYPE_POINT, LIGHT_TYPE_SPOT } from './values.js';

var LightingFalloffMode;
...
class EnvironmentLight extends AmbientLight {
    _radianceMap;
    _irradianceMap;
...
class HemiSphericLight extends AmbientLight {
    _colorUp;
    _colorDown;
    constructor(scene) {
...
export { AmbientLight, BaseLight, DirectionalLight, EnvironmentLight, HemiSphericLight, LightingFalloffMode, PointLight, PunctualLight, SpotLight };
