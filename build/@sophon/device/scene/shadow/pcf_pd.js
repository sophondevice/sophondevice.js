...
import { computeShadowMapDepth, computeReceiverPlaneDepthBias, filterShadowPoissonDisc } from '../renderers/shadowmap.shaderlib.js';

class PCFPD extends ShadowImpl {
    _tapCount;
    _sampleRadius;
    _shadowSampler;
        ...
        if (!pb.getFunction(funcNameComputeShadowCSM)) {
            pb.globalScope.$function(funcNameComputeShadowCSM, [pb.vec4('shadowVertex'), pb.float('NdotL'), pb.int('split')], function () {
                ...
                this.$if(this.inShadow, function () {
                    ...
                    this.shadow = filterShadowPoissonDisc(this, shadowMapper.light.lightType, shadowMapper.shadowMap.format, that._tapCount, this.shadowCoord, this.receiverPlaneDepthBias, this.split);
                });
            ...
            pb.globalScope.$function(funcNameComputeShadow, [pb.vec4('shadowVertex'), pb.float('NdotL')], function () {
                if (shadowMapper.light.isPointLight()) {
                    ...
                    this.$if(this.inShadow, function () {
                        ...
                        this.shadowCoord.z = pb.sub(this.shadowCoord.z, this.shadowBias);
                        this.shadow = filterShadowPoissonDisc(this, shadowMapper.light.lightType, shadowMapper.shadowMap.format, that._tapCount, this.shadowCoord, this.receiverPlaneDepthBias);
                    });
                    this.$return(this.shadow);
                }
            });
