/** sophon base library */
import { zip } from '@sophon/base';
import { TextureWrapping, TextureFilter, CompareFunc, PrimitiveType, TextureFormat } from '../base_types.js';
import { StencilOp, FaceWinding, FaceMode, BlendEquation, BlendFunc } from '../render_states.js';
...
const textureFormatInvMap = zip(Object.values(textureFormatMap), Object.keys(textureFormatMap).map(val => Number(val)));
