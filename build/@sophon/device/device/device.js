...
const DEVICE_TYPE_WEBGPU = 'webgpu';
class DeviceResizeEvent extends REvent {
    static NAME = 'resize';
    width;
    height;
...
class DeviceFrameBegin extends REvent {
...
class DeviceFrameEnd extends REvent {
...
class DeviceGPUObjectAddedEvent extends REvent {
...
class DeviceGPUObjectRemovedEvent extends REvent {
...
class DeviceGPUObjectRenameEvent extends REvent {
...
export { DEVICE_TYPE_WEBGL, DEVICE_TYPE_WEBGL2, DEVICE_TYPE_WEBGPU, Device, DeviceFrameBegin, DeviceFrameEnd, DeviceGPUObjectAddedEvent, DeviceGPUObjectRemovedEvent, DeviceGPUObjectRenameEvent, DeviceLostEvent, DeviceResizeEvent, DeviceRestoreEvent };
