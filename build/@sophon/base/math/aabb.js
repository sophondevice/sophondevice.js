...
import { BoxSide, ClipState } from './clip_test.js';
...
class AABB {
    ...
    containsBox(other) {
        return (this._minPoint.x <= other._minPoint.x &&
    ...
    getClipStateMask(viewProjMatrix, mask) {
        ...
        for (let i = 0; i < 8; i++) {
            let clip = 0;
            v0.set(i & 1 ? minPoint.x : maxPoint.x, i & 2 ? minPoint.y : maxPoint.y, i & 3 ? minPoint.z : maxPoint.z);
